...
unoglobal.getBuffer = async function getBuffer(url, options) {
try {
options ? options : {}
var res = await axios({
method: "get",
...
global.canalIdM = ["120363279797793704@newsletter", "120363279797793704@newsletter", "120363279797793704@newsletter"]
