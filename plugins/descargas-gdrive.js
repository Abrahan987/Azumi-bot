...
const mssg = {
    ...
    usage: (command, prefix) => `\`\`\`[ ❤️ ] Uso correcto del comando:\`\`\` ${prefix + command} https://drive.google.com/file/d/0B_Kq5LGHEATLX080YzJRVWFHMG8/view?resourcekey=0-c8UyatTkwaRkp4skEYYLGg`,
