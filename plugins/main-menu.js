...
let handler = async (m, { conn, args }) => {
    ...
    // URL de la imagen del encabezado (coloca tu URL aquí)
    let headerImage = 'https://files.catbox.moe/5syg7h.jpg';
...
`.trim();
    ...
    // Primero enviar la imagen del encabezado
    try {
        ...
        console.error("Error al enviar la imagen del encabezado:", error);
    }
    
    // Luego enviar el video con el menú
    let messageOptions = {
...
export default handler;┃✿ .usuarios
┃✿ .user
┃✿ .ds
┃✿ .listprem
┃✿ .status
